...
rankhospital("OR", "heart attack", "best")
rankhospital("OR", "heart attack", "worst")
rankhospital("OR", "heart failure", "best")
rankhospital("OR", "heart failure", "worst")
...
# For example, the call rankhospital("MD", "heart failure", 5) would return a 
...
# from the set of hospitals when deciding the rankings. Handling ties. It may
# occur that multiple hospitals have the same 30-day mortality rate for a given
# cause of death. In those cases ties should be broken by using the hospital
# name. For example, in Texas (“TX”), the hospitals with lowest 30-day mortality
...
# 
# Use the submit script provided to submit your solution to this part. There are
# 4 tests that need to be passed for this part of the assignment.
